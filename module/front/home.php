            ...
            <a href="javascript:void(null)" class="prev">&nbsp;</a>
       	  <div class="anyClass scrol">
                ...
                <?php
					...
					$sql='select `id`,`name`,`img_url`,`price` from `nn_product` order by `view` DESC limit 0,10';
            ...
            <div class="listing">
                ...
                <ul>
                  <?php
					//Lay 20 SP moi nhat
					$sql='select `id`,`name`,`img_url`,`price` from `nn_product` order by `id` DESC limit 0,20';
					$rs=mysqli_query($link,$sql);
					$i=1;
					while($r=mysqli_fetch_assoc($rs))
					{
