            ...
            <div class="listing">
				...
				?>
                        <li <?php  if($i%4==0) echo 'class="last"'; ?>>
                            <a href="san-pham-<?php echo str_replace(' ','-',$r['name'])?>-<?php echo $r['id']  ?>.html" class="thumb"><img src="images/sanpham/<?php if(is_file('images/sanpham/'.$r['img_url']))echo $r['img_url'];else echo 'noImage.jpg'?>" alt="" ></a>
