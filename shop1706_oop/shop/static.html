    ...
    <div class="content_sec">
        <div class="col3">
            ...
            <div class="col3_center">
                ...
                <p class="bord_botm bord_top">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Sed elit. Nulla sem risus, vestibulum in, volutpat eget, dapibus ac, lectus. Curabitur dolor sapien, hendrerit non, suscipit bibendum, auctor ac, arcu. Vestibulum dapibus. Sed pede lacus, pretium in, condimentum sit amet, mollis dapibus, magna. Ut bibendum dolor nec augue. Ut tempus luctus metus. Sed a velit. Pellentesque at libero elementum ante condimentum sollicitudin. Pellentesque lorem ipsum, semper quis, interdum et, sollicitudin eu, purus. Vivamus fringilla ipsum vel orci. Phasellus vitae massa at massa pulvinar pellentesque. Fusce tincidunt libero vitae odio. Donec malesuada diam nec mi. Integer hendrerit pulvinar ante.
                </p>
                <div class="sec1">
               	  <h3 class="colr">adipiscing elit</h3>
                  <ul class="arow">
                  	<li>Lorem ipsum dolor sit amet</li>
                    <li>Cras vel libero id lectus rhoncus porta.</li>
                    <li>Lorem ipsum dolor sit amet</li>
                    <li>Cras vel libero id lectus rhoncus porta.</li>
                    <li>Lorem ipsum dolor sit amet</li>
                    <li>Cras vel libero id lectus rhoncus porta.</li>
                ...
                <div class="clear"></div>
                <div class="clear"></div>
                	<p class="bord_top bord_botm">
                        Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Sed elit. Nulla sem risus, vestibulum in, volutpat eget, dapibus ac, lectus. Curabitur dolor sapien, hendrerit non, suscipit bibendum, auctor ac, arcu. Vestibulum dapibus. Sed pede lacus, pretium in, condimentum sit amet, mollis dapibus, magna. Ut bibendum dolor nec augue. Ut tempus luctus metus. Sed a velit. Pellentesque at libero elementum ante condimentum sollicitudin. Pellentesque lorem ipsum, semper quis, interdum et, sollicitudin eu, purus. Vivamus fringilla ipsum vel orci. Phasellus vitae massa at massa pulvinar pellentesque. Fusce tincidunt libero vitae odio. Donec malesuada diam nec mi. Integer hendrerit pulvinar ante. Donec eleifend, nisl eget aliquam congue, justo metus venenatis neque, vel tincidunt elit augue sit amet velit. Nulla facilisi. Aenean suscipit. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Sed elit. Nulla sem risus, vestibulum in, volutpat eget, dapibus ac, lectus. Curabitur dolor sapien, hendrerit non, suscipit bibendum, auctor ac, arcu. Vestibulum dapibus. Sed pede lacus, pretium in, condimentum sit amet, mollis dapibus, magna. Ut bibendum dolor nec augue. Ut tempus luctus metus. Sed a velit. Pellentesque at libero elementum ante condimen Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Sed elit. Nulla sem risus, vestibulum in, volutpat eget, dapibus ac, lectus. Curabitur dolor sapien, hendrerit non, suscipit bibendum, auctor ac, arcu. Vestibulum dapibus. Sed pede lacus, pretium in, condimentum sit amet, mollis dapibus, magna. Ut bibendum dolor nec augue. Ut tempus luctus metus. Sed a velit. Pellen
                	</p>
                    <br >
                    <h3 class="heading colr">Forms and tables</h3>
          			<ul class="forms">
                    	<li class="txt">Name</li>
                        <li class="inputfield"><input type="text" class="bar" ></li>
                    </ul>
                    <ul class="forms">
                    ...
                    <ul class="forms">
                        ...
                        <li class="check"><input name="item" type="checkbox" value="" class="left" ></li>
                    </ul>
                    <ul class="forms">
                    	<li class="txt">Item</li>
                        <li class="check"><input name="item" type="checkbox" value="" class="left" ></li>
                    ...
                    <ul class="forms">
                    	<li class="txt">Item</li>
                        <li class="check"><input name="item" type="radio" value="" class="left" ></li>
                    </ul>
                    <ul class="forms">
                    	<li class="txt">Item</li>
                        <li class="check"><input name="item" type="radio" value="" class="left" ></li>
