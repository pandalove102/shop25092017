            <?php
				...
				include_once('model/Model_Category.php');
				
				$p=new Product();
				$r=$p->get($id);
			?>
            <div class="crumb" style="width:680px">
                <ul>
                    <li class="first"><a href="#">Home</a></li>
                    <li><a href="?mod=list&cid=<?php echo $r['category_id']?>">
                    <?php
						$c=new Category();
						$rCate=$c->get($r['category_id']);
						echo $rCate['name'];
					?>
                    </a></li>
                </ul>
            ...
            <div class="listing">
                ...
                <ul>
                  <?php
					...
					$rs=$p->getAll("`category_id`=$cid  AND `id`!=$id","`id` DESC ",0);
					$i=1;
